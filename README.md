...
GOVAIL_API_KEYS="<RANDOM_API_KEY>:example-project:user:60,<RANDOM_ADMIN_KEY>:ops:admin:300"
```
...
| `GOVAIL_API_KEYS` | 쉼표 구분 런타임 API Key 매핑 (형식: `key:project:role[:rpm]`) |
| `GOVAIL_UPSTREAM_API_KEY` | 업스트림 호출용 자격증명(런타임 주입 필수) |
